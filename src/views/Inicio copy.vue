...
<script>
  ...
  export default {
    ...
    data () {
      return {
        idInstitucion: 'eb58bf60-fc83-11ec-a1d1-1dc2835404e5', // INEM
        ...
        periodo: 'PRIMERO',
        idPeriodo: 1,
        nombreInstitucion: 'INSTITUCIÓN EDUCATIVA INEM CARLOS ARTURO TORRES',
        ...
        escudoInstitucion: 'escudo-inem.png',
